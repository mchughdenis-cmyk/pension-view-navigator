            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div><Label className="text-muted-foreground text-xs">Full Name</Label><p className="font-medium">{clientDetail.name}</p></div>
                  <div><Label className="text-muted-foreground text-xs">Date of Birth</Label><p className="font-medium">{clientDetail.dob}</p></div>
                  <div><Label className="text-muted-foreground text-xs">Email</Label><p className="font-medium">{clientDetail.email}</p></div>
                  <div><Label className="text-muted-foreground text-xs">Phone</Label><p className="font-medium">{clientDetail.phone}</p></div>
                  <div><Label className="text-muted-foreground text-xs">NI Number</Label><p className="font-medium">{clientDetail.nino}</p></div>
                  <div><Label className="text-muted-foreground text-xs">Address</Label><p className="font-medium">{clientDetail.address}</p></div>
                </div>
                <Button variant="outline" size="sm" className="mt-2"><Edit className="w-4 h-4 mr-2" /> Edit Details</Button>
              </CardContent>
            </Card>
            <Card>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button size="sm"><Plus className="w-4 h-4 mr-2" /> Open New Account</Button>
              </div>
            </CardHeader>
            <CardContent>
                ...
                {clientDetail.accounts.map((account, i) => (
                  <div key={i} className="p-4 border rounded-lg hover:bg-accent/50 transition-colors">
                    ...
                    <div className="flex gap-2 mt-3">
                      <Button variant="outline" size="sm"><Eye className="w-4 h-4 mr-2" /> View Holdings</Button>
                      <Button variant="outline" size="sm"><TrendingUp className="w-4 h-4 mr-2" /> Transactions</Button>
                      <Button variant="outline" size="sm"><Edit className="w-4 h-4 mr-2" /> Manage</Button>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Account</TableHead><TableHead className="text-right">Amount</TableHead><TableHead>Status</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Method</TableHead><TableHead>Frequency</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="text-right">Cumulative</TableHead><TableHead>Status</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" className="w-full"><RefreshCw className="w-4 h-4 mr-2" /> Trigger Reverification</Button>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 border rounded-lg">
                  <div className="flex items-center justify-between mb-2"><p className="font-medium">Current Risk Profile</p><Badge variant="outline">{clientDetail.riskProfile}</Badge></div>
                ...
                <Button variant="outline" className="w-full"><Edit className="w-4 h-4 mr-2" /> Update Risk Profile</Button>
              </CardContent>
            </Card>
          </div>
        )
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button size="sm"><Send className="w-4 h-4 mr-2" /> New Communication</Button>
              </div>
            </CardHeader>
            ...
            <Card>
              ...
              <CardContent>
                <div className="mb-4 space-y-2">
                  ...
                  <Button size="sm" disabled={!newNote.trim()}><Plus className="w-4 h-4 mr-2" /> Add Note</Button>
                </div>
                <div className="space-y-3">
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <Button variant="outline" className="w-full justify-start"><RefreshCw className="w-4 h-4 mr-2" /> Reset Client Password</Button>
                <Button variant="outline" className="w-full justify-start"><User className="w-4 h-4 mr-2" /> Reassign Adviser</Button>
                <Button variant="outline" className="w-full justify-start"><FileText className="w-4 h-4 mr-2" /> Generate Statement</Button>
                <Button variant="outline" className="w-full justify-start"><Download className="w-4 h-4 mr-2" /> Export All Data (GDPR)</Button>
                <Button variant="destructive" className="w-full justify-start"><Ban className="w-4 h-4 mr-2" /> Close Account</Button>
              </CardContent>
            </Card>
          </div>
        )
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-primary">{formatCurrency(clientDetail.accounts.reduce((s, a) => s + a.value, 0))}</div>
