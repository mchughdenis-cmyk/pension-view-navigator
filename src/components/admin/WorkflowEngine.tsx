...
const recentExecutions = [
  { id: 1, workflow: 'Contribution Receipt', client: 'John Smith', date: '2024-01-15 11:00', result: 'success', detail: 'Email sent to john.smith@email.com' },
  { id: 2, workflow: 'Large Transaction Alert', client: 'David Thompson', date: '2024-01-14 16:00', result: 'success', detail: 'Alert sent to compliance team' },
  { id: 3, workflow: 'Failed Payment Retry', client: 'Lisa Anderson', date: '2024-01-12 09:00', result: 'success', detail: 'Retry scheduled for 2024-01-15' },
  { id: 4, workflow: 'Annual Review Reminder', client: 'Emma Wilson', date: '2024-01-10 08:00', result: 'success', detail: 'Task created, email sent to adviser' },
  { id: 5, workflow: 'KYC Expiry Reminder', client: '15 clients', date: '2024-01-08 07:00', result: 'partial', detail: '14 emails sent, 1 bounced' },
]
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            ...
            <Button size="sm"><Plus className="w-4 h-4 mr-2" /> New Workflow</Button>
          </div>
        </CardHeader>
        <CardContent>
