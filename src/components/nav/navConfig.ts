import {
  ...
  Landmark, Globe2, FileSpreadsheet, Upload, AlertTriangle, Wallet,
} from "lucide-react";
  ...
  admin: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Death claims / bereavement", url: "/admin?tab=death-claims", icon: Heart },
        { title: "Pension sharing orders (divorce)", url: "/admin?tab=psos", icon: ArrowRightLeft },
