// Plain-English pension jargon definitions (UK 2026/27)
...
export const JARGON: Record<string, string> = {
  ...
  ISA: "Individual Savings Account — tax-free investment wrapper with a £20,000 annual allowance (2026/27).",
  ...
  "Annual Allowance": "The most you can pay into pensions each tax year with tax relief — £60,000 in 2026/27, tapering down for high earners.",
  ...
  LSA: "Lump Sum Allowance — total tax-free lump sums you can take across all pensions in your lifetime: £268,275 (2026/27).",
  LSDBA: "Lump Sum and Death Benefit Allowance — total tax-free lump sums, including on death: £1,073,100 (2026/27).",
