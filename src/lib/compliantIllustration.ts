...
export function generateCompliantIllustrationPdf(input: IllustrationInput) {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ["Tax-Free Cash (PCLS)", "25% taken at vesting (max £268,275 LSA, 2026/27)"],
  ...
  const warnings = [
    ...
    "Taking your tax-free cash and any taxable income may have tax consequences and could trigger the Money Purchase Annual Allowance (MPAA) of £10,000 (2026/27), restricting future pension contributions.",
    "The Lump Sum Allowance (LSA) of £268,275 and the Lump Sum and Death Benefit Allowance (LSDBA) of £1,073,100 apply for the 2026/27 tax year. Lump sums above these limits may be taxed at your marginal rate.",
